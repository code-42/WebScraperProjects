// This tutorial from  .https://www.codeproject.com/Articles/823854/How-to-connect-SQL-Database-to-your-Csharp-program
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                // Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\MyDox\C_sharp_projects\Cookbook\Cookbook\Cookbook.mdf;Integrated Security=True;Connect Timeout=30
                // conn.ConnectionString = @"(LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\MyDox\C_sharp_projects\SQLCodeProject\SQLCodeProject\SQLCodeProject\Program.mdf; Integrated Security = True";Trusted_Connection=true";
                conn.ConnectionString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\MyDox\C_sharp_projects\WebScraperProjects\SQLCodeProject\SQLCodeProject\Program.mdf; Integrated Security = True; Connect Timeout = 30";
                // conn.ConnectionString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = C:\MyDox\C_sharp_projects\SQLCodeProject\SQLCodeProject\SQLCodeProject\Program.mdf; Integrated Security = True;";

                conn.Open();
                // Create the command
                SqlCommand command = new SqlCommand("SELECT * FROM SQLCodeProject WHERE FirstColumn = @0", conn);
                // Add the parameters.
                ...
                SqlCommand command2 = new SqlCommand("SELECT * FROM SQLCodeProject", conn);
                // Add the parameters.
                ...
                Console.WriteLine("All Data displayed! Now press enter to move to the next section!");
                Console.ReadLine();
                Console.Clear();
                ...
                //  SqlCommand insertCommand = new SqlCommand("INSERT INTO SQLCodeProject (FirstColumn, SecondColumn, ThirdColumn, ForthColumn) VALUES (@0, @1, @2, @3)", conn);
                SqlCommand insertCommand = new SqlCommand("INSERT INTO SQLCodeProject (FirstColumn, SecondColumn, ThirdColumn) VALUES (@0, @1, @2)", conn);
                ...
                SqlCommand command3 = new SqlCommand("SELECT * FROM SQLCodeProject", conn);
                // Add the parameters.
                //command2.Parameters.Add(new SqlParameter("0", 1));
                ...
                try
                {
                    ...
                    SqlCommand errorCommand = new SqlCommand("SELECT * FROM someNonTable", conn);
